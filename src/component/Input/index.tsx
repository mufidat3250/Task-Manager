const Input = ({onChange, type, value, otherClass, placeHolder}:{onChange:(e:React.ChangeEvent<HTMLInputElement>)=> void,  value:string, type?:string, otherClass:string, placeHolder:string}) => {
  return (
